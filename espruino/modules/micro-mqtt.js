        ...
        this.handleData = function (data) {
            ...
            switch (controlPacketType) {
                ...
                case 3 /* Publish */:
                    ...
                    if (message_1.qos > 0) {
                        setTimeout(function () { _this.sct.write(Protocol.createPubAck(message_1.pid || 0)); }, 0);
                    }
                    if (message_1.next) {
        ...
        if (this.wdId === -123 /* Uninitialized */) {
            this.wdId = setInterval(function () {
                if (!_this.connected) {
                    ...
                    if (_this.piId !== -123 /* Uninitialized */) {
                        clearInterval(_this.piId);
                        _this.piId = -123 /* Uninitialized */;
                    }
                    if (_this.sct) {
                        _this.sct.removeAllListeners('connect');
                        _this.sct.removeAllListeners('data');
                        _this.sct.removeAllListeners('close');
                        _this.sct.end();
                    }
                    _this.connect();
                }
...
(function (Protocol) {
    ...
    Protocol.remainingLength = remainingLength;
    /**
     * Connect flags
